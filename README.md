...
- Civic Technology & Nonprofit Analytics

Core questions I study:
- How does media language influence market behavior?
- How do platform signals (ratings, algorithms) shape consumer demand?
- How can data optimize marketing, fundraising, and engagement strategies?
- How do audiences perceive AI versus human creativity?
...
- Python, R, SQL  
- Tableau  
- Keyhole, Brand24, RivalIQ  
- Regression, ANCOVA, A/B Testing  

# 3. Core Analytical Projects

## 3.1 NYT Headlines × Stock Market Prediction (NLP Project)
...
Data & Methods:
- NYT financial headlines (text corpus)
- TF-IDF + supervised machine learning
- Sentiment and topic analysis
- Classification models for next-day market movement
...
## 3.2 Video Game Sales × Platform-Specific Ratings (Independent Research)
...
- OLS regression with platform × rating interactions
- Signaling theory framework

Key Findings:
- Critic scores have stronger impact on console markets
...
## 3.3 NYC Mayoral Election Digital Intervention (Civic Data Project)

Objective:  
Test whether peer-to-peer digital voter outreach increases civic participation.

Data & Methods:
- Voter outreach experimental design
- Peer-network based digital messaging
- Turnout and behavioral outcome measurement
- Intervention vs. non-intervention comparison
...
Design:
- Survey-based A/B experiment (n = 108)

Methods:
- Regression analysis
- ANCOVA
- Moderating factors: AI usage frequency, art exposure, education level

Key Findings:
- Audience evaluations of creativity are systematically shaped by AI familiarity and exposure
- Implications for AI branding and creative industry strategy
...
- Content coding & sentiment analysis
- Engagement rate benchmarking
- Competitor analysis using Keyhole, Brand24, RivalIQ
...
## 3.6 PEER – Digital Fundraising & Engagement Analytics (NGO Project)
...
## 3.7 Education Without Barriers (EWB) – Public Engagement & Growth Analytics

Objective:  
Scale nonprofit visibility, recruitment, and public education through precision content strategies.

Data & Methods:
- Founded and managed RED (Xiaohongshu) account
- Achieved 500+ targeted recruits in short time
